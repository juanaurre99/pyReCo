...
Use case: predict sin(t+dt) from sin(t) (scalar-to-scalar mapping taskI)
"""

# some testing data: predict a sine signal.
X_train, X_test, y_train, y_test = vector_to_vector(name='sine_prediction', n_states=1, n_batch=200)
...
model_rc.add(RandomReservoirLayer(nodes=100, density=0.5, leakage_rate=0.1 ,
                                  activation='sigmoid', fraction_input=0.5))
